...
// --- END OF NEW RC4 CIPHER LOGIC ---
 ...
 // Asymmetric Encryption Logic (RSA and Diffie-Hellman)
        ...
        generateKeyPairButton.addEventListener('click', async () => {
            try {
                const keyPair = await window.crypto.subtle.generateKey(
                    ...
                    true, // Whether the key is extractable (i.e. can be used in exportKey or exportJwk)
        ...
        rsaEncryptButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const publicKey = await window.crypto.subtle.importKey(
                    ...
                    true, // Ensure extractable is true if you want to export it later (though not needed for encrypting)
                    ["encrypt"]
                );
        ...
        rsaDecryptButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const privateKey = await window.crypto.subtle.importKey(
                    ...
                    true, // Ensure extractable is true if you want to export it later (though not needed for decrypting)
                    ["decrypt"]
                );
    ...
    } // End of asymmetric-encryption.html block
}); // <--- This is the very last closing brace for DOMContentLoaded
